              ...
              {extractedDecisions.map((d, i) => (
                <div key={i} className="flex items-start gap-3 p-3 rounded-xl border border-border bg-secondary/20">
                  ...
                  <div className="flex gap-1 shrink-0">
                    <Button size="sm" variant="ghost" onClick={() => onSaveDecision(d)} className="h-8 w-8 p-0 text-green-400 hover:text-green-300 hover:bg-green-500/10"><Check className="w-4 h-4" /></Button>
                    <Button size="sm" variant="ghost" onClick={() => onDismissExtracted(i)} className="h-8 w-8 p-0 text-destructive hover:text-red-300 hover:bg-destructive/10"><X className="w-4 h-4" /></Button>
                  </div>
                </div>
              ))}
            </div>
