...
import { FiHome, FiFileText, FiGitPullRequest, FiSettings } from 'react-icons/fi'
...
const navItems = [
  ...
  { id: 'decisions', label: 'Decisions', icon: FiFileText },
  { id: 'pull-requests', label: 'Pull Requests', icon: FiGitPullRequest },
    ...
    <aside className="w-16 lg:w-56 min-h-screen border-r border-border flex flex-col py-6 px-2 lg:px-4 shrink-0" style={{ background: 'hsl(231, 18%, 12%)' }}>
      <div className="flex items-center gap-2 mb-8 px-1 lg:px-2">
        <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center">
          <FiGitPullRequest className="w-4 h-4 text-primary-foreground" />
        </div>
